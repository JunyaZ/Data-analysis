...
for i in range(0,8470,50):
    ...
    with open(f"\\\\egr-1l11qd2\\CLS_lab\\Junya Zhao\\Data driven model _paper [June 25_2018\\NonOverlap_featureSelection\\EvlReport\\{i}_Label.csv","w") as fo:
...
if not chisq_installed:
    ...
    sys.exit(1)
"""
data_dir = "\\\\egr-1l11qd2\\CLS_lab\\Junya Zhao\\\Data driven model _paper [June 25_2018\\NonOverlap_featureSelection\\EvlReport\\"
...
for csv in globbed_files:
    ...
    with open(f"{csv}._Evlreport.csv","a") as outfile:  
